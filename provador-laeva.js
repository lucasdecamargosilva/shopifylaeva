(function () {
    ...
    const styles = `
        ...
        .mc-powered-footer span { font-size: 8px; letter-spacing: 1.2px; text-transform: uppercase; color: var(--mc-text-light); }
        .mc-quantic-logo { height: 14px; width: auto; opacity: 0.7; }
